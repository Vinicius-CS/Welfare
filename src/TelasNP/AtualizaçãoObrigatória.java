...
public class AtualizaçãoObrigatória extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AtualizaçãoObrigatória frame = new AtualizaçãoObrigatória();
	 ...
	 * Create the frame.
	 */
	public AtualizaçãoObrigatória() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(AtualizaçãoObrigatória.class.getResource("/\u00CDcones/LogoMenorAinda.png")));
		...
		btnNutricionista.setIcon(new ImageIcon(AtualizaçãoObrigatória.class.getResource("/\u00CDcones/Atualizar.png")));
